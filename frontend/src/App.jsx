...
function App() {
  ...
  return <div className="app">
    <div className="space-background" aria-hidden="true"><span className="star-field star-field-one" /><span className="star-field star-field-two" /><span className="nebula nebula-one" /><span className="nebula nebula-two" /><span className="planet" /><span className="shooting-star" /><span className="orbital-craft" /></div>
